...
/// <summary>
/// Логика взаимодействия для RightAnswerLozengeView.xaml
/// </summary>
public partial class RightAnswerLozengeView : ReactiveUserControl<IAnswerLozengeViewModel>
{
    public RightAnswerLozengeView()
    {
        InitializeComponent();

        imgBackground.ImageSource = ResourceManager.GetImageSource("lozenge right", "png", "Lozenge");
        imgRhomb.Source = ResourceManager.GetImageSource("lozenge rhomb", "png", "Lozenge");

        imgLocked.ImageSource = ResourceManager.GetImageSource("lozenge right locked", "png", "Lozenge");
        imgRhombLocked.Source = ResourceManager.GetImageSource("lozenge rhomb white", "png", "Lozenge");

        imgCorrect.ImageSource = ResourceManager.GetImageSource("lozenge right correct", "png", "Lozenge");
